...
4. Keyboard behavior
5. Introduction of the filter attribute
6. Introduction of the search attribute
...
3. **&lt;selectedoptions>** : Container for displaying selected items.
    4. **Slots:**
        8. **selectedoption** (optional): To display the current selected option from the listbox. 
...
6. **&lt;optgroup>** (Optional): A container to group related options together.
    6. **Slots**:
        11. **legend**: To label the group.
        12. **option**: The options within this group.
    7. 
...
&lt;selectedoptions> is where we put all the choices a user has made in a combobox. It's a place that shows users what they've picked.

E.g


```
<selectedoptions view="tags">
   <selectedoption>Apple</selectedoption>
   <selectedoption>Orange</selectedoption>
 </selectedoptions>
```



##### What's the `**view**` thing?

The view attribute changes how these choices look. Here's what it can do:

The view attribute's value instructs the user agent on the presentation style for the &lt;selectedoption> elements contained within &lt;selectedoptions>. This behavioral instruction simplifies the developer's task, without the need for additional markup or complex scripting.

Depending on the view setting, various interactive and visual elements (such as 'remove' buttons or count indicators) are automatically introduced into the dom.

**Display Modes:**

tags: Each choice becomes a little 'tag' you can see (and usually remove) directly.
...
inline: All choices are inline, staying inside the input area.


```
<selectedoptions view="inline">
```


list: All choices go into a simple list, comma separated values.


```
<selectedoptions view="list">
```


count: Instead of seeing all the choices, you just see how many there are, like '3 picked'.


```
<selectedoptions view="count">
```


hidden: You don't see the choices right away. You have to click something to see them, keeping things neat.


```
<selectedoptions view="hidden">
```



##### Combobox with multiselect: `**multiple`** attr / `selectedoption**s`**

**Option#1**: Selected values below the input
...
```
<combobox multiple>
    <input type="selectlist" placeholder="Select fruits...">
    <selectedoptions view="tags">
        <selectedoption>Apple</selectedoption>
        <selectedoption>Orange</selectedoption>
    </selectedoptions>
...
**Option#2: **Selected options within the input box 
...
The introduction of the **filter** bool attribute revolutionizes the way users interact with combobox elements. By narrowing down visible options based on real-time input.
...
The introduction of the **search** attribute brings dynamic adaptability to combobox elements. It facilitates real-time fetching of options based on user input. 
...
The current behavior of &lt;selectlist> is the startswith value
...
<combobox search>
    ...
    <listbox>
        <!-- Results are dynamically populated based on the search -->
        <!-- ... -->
    </listbox>
</combobox>
```
...
<p id="gdcalert57" ><span style="color: red; font-weight: bold">>>>>>  gd2md-html alert: inline image link here (to images/image57.gif). Store image on your image server and adjust path/filename/extension if necessary. </span><br>(<a href="#">Back to top</a>)(<a href="#gdcalert58">Next alert</a>)<br><span style="color: red; font-weight: bold">>>>>> </span></p>
...
<p id="gdcalert68" ><span style="color: red; font-weight: bold">>>>>>  gd2md-html alert: inline image link here (to images/image68.gif). Store image on your image server and adjust path/filename/extension if necessary. </span><br>(<a href="#">Back to top</a>)(<a href="#gdcalert69">Next alert</a>)<br><span style="color: red; font-weight: bold">>>>>> </span></p>
...
<p id="gdcalert70" ><span style="color: red; font-weight: bold">>>>>>  gd2md-html alert: inline image link here (to images/image70.gif). Store image on your image server and adjust path/filename/extension if necessary. </span><br>(<a href="#">Back to top</a>)(<a href="#gdcalert71">Next alert</a>)<br><span style="color: red; font-weight: bold">>>>>> </span></p>
